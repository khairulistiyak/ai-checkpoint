      ...
      <AnimatePresence mode="wait">
        {isMinimized ? (
          ...
          <motion.div
            ...
            className="relative rounded-2xl p-px bg-gradient-to-r from-sky-500/25 via-purple-500/25 to-emerald-500/25 shadow-[0_20px_60px_rgba(0,0,0,0.85)]"
          >
              ...
              <div className="flex items-center gap-2.5 min-w-0 flex-1 px-1">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-xs font-semibold text-zinc-100 truncate max-w-[12.5rem] sm:max-w-xs md:max-w-sm tracking-tight">
