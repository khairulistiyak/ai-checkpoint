...
export default function Header({ onOpenSettings, onOpenCommandPalette, onToggleMenu }) {
  return (
    <motion.header
      ...
      className="m-4 md:m-6 rounded-xl border border-white/[0.05] bg-[#0a0f1c]/70 backdrop-blur-xl flex items-center justify-between px-4 md:px-6 py-3 sticky top-4 md:top-6 z-20"
    >
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <div 
          className="bg-gradient-to-br from-indigo-500 to-purple-500 p-2 md:p-2 rounded-lg hidden sm:block"
        >
