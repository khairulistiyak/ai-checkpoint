...
export default function GitEmptyCheckpoints({ onCopyCommand }) {
  return (
    <div className="h-full min-h-[13.75rem] flex flex-col items-center justify-center p-8 text-center text-white/60 bg-white/[0.02] border border-white/5 rounded-2xl">
